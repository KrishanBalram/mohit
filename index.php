...
<html>
  <head>
    ...
    // Listen for keyup event on the search box
    $('#search_text').keyup(function () {
        var search = $(this).val();
        if (search != '') {
            load_data(search); // Fetch and display data
        } else {
...
<!-- <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top"style="font-weight:bold;font-size:18px; color: white;
background-color:black;
    background-image: url(img/annima.jpg);
    background-size: contain;
    -webkit-background-clip: text;
    -webkit-text-fill-color:transparent;"> -->
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top"style="background-image: url(img/annima.jpg);
    background-size: contain;">
  
    <a class="navbar-brand" href="index.php"><span style="font-weight:bold;font-size:35px; color: white;
    background-image: url(img/flag.jpg);
    background-size: contain;
    -webkit-background-clip: text;
    -webkit-text-fill-color:transparent;">Foodie Express</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<!--slider ends-->
 ...
 <br><br><br><br>
<div>
	<h2 style="margin-left:300px;font-weight:bold;font-size:70px; color: white;
    font-size: 60px;
    text-align: center;
    background-image: url(img/flag.jpg);
    background-size: contain;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; 
	margin-right:100px;">Welcome to Foodie Express</h2>
	<img style="background-size:cover; width:100%;height:65%;" src="img\delivery.jpg" alt="">
...
<h3 style="font-weight:bold;font-size:50px; color: white;
text-align: center;
    background-image: url(img/annima.jpg);
    background-size: contain;
    -webkit-background-clip: text;
    -webkit-text-fill-color:transparent;"> Always Ready To Serve You!!!</h3>
<br><br>
<br><br>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-6">
	<div class="container-fluid">
	 <img src="img/f1.webp" height="300px" width="100%">
	</div>
	 <div class="container">
	 <p style="font-family:'sans-serif', cursive; font-weight:light;  font-size:25px;"><br>Foodie Express makes it simple and secure to create an account where you can save your delivery addresses and payment details for faster ordering in the future. You can use a virtual shopping cart to customize and review your order before checkout. Customers can choose between delivery or pickup, add special delivery instructions, and pay using cards or mobile wallets. Real-time tracking lets you follow your order's progress, from preparation to delivery..</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family:'sans-serif', cursive; font-weight:light; font-size:25px;"><br>Foodie Express is a website that helps you order food from nearby restaurants easily. You can track your order, read reviews, and get recommendations. It works well on phones and links to social media for extra convenience..</p>
	        </div>
	  </div>
