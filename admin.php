...
class AdminLogin
{
    ...
    {
        $query = $this->db->prepare("SELECT * FROM tbadmin WHERE fld_username = ? AND fld_password = ?");
...
if (isset($_POST['login'])) {
    ...
    $adminLogin->setCredentials($_POST['username'], $_POST['pswd']);
    $adminLogin->authenticate();

    if (!empty($adminLogin->loginError)) {
        echo $adminLogin->loginError;
    }
}
?>
...
<br><br><br><br><br><br>
<div class="container" style="background-image:url(img/customer.jpg); height:100vh;width:100vw">
