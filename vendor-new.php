...
<body>
<div style="background-image: url('img/anni.jpg'); height: 800px;width:100%;">
...
<div class="middle" style="margin:0px auto; border:1px solid #F8F9FA;  width:800px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background: #91ffcf;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:purple;" id="register-tab" data-toggle="tab" href="#register" role="tab" aria-controls="register" aria-selected="true">Register</a>
          </li>
		  <li class="nav-item">
             <a class="nav-link " id="login-tab" style="color:grey;" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">Log In</a>
          </li>
       </ul>
	   <br><br>
	   <!--tab 1 starsts-->
	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data >
                      <div class="form-group">
                          ...
                          <input type="text" autocomplete="off" class="form-control" id="name" value="<?php if(isset($r_name)) { echo $r_name;}?>" placeholder="Enter Restaurant Name" name="r_name" required/>
                      </div>
	                  <div class="form-group">
                          <label for="name"style="color:red">Email Id:</label>
	                 ...
	                 <div class="form-group">
                          <label for="add"style="color:red">Address:</label>
	                 ...
	                 <div class="form-group">
                          <input type="file"  name="logo" style="color:red"required>Upload Logo 
                     </div>
